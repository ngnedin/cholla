...
void Potential_PFFT_3D::Initialize( Real Lx, Real Ly, Real Lz, Real x_min, Real y_min, Real z_min, 
                                    ...
                                    Real dx_real, Real dy_real, Real dz_real)
{
  ...
  chprintf( "  PFFT: Computing K for Gravity Green Function\n");
...
void Potential_PFFT_3D::Apply_G_Function( void )
{
  Real G_val;
  int i;
...
void Potential_PFFT_3D::Apply_K2_Function( void )
{
  Real kx, ky, kz, k2;
  int i_g, j_g, k_g;
  int id;
