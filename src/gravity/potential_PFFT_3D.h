...
// #define ANALYTIC_POISSON_SOLVER
...
class Potential_PFFT_3D
{
  ...
  void Initialize( Real Lx, Real Ly, Real Lz, Real x_min, Real y_min, Real z_min, int nx, int ny, 
                   int nz, int nx_real, int ny_real, int nz_real, Real dx, Real dy, Real dz );
  ...
  void Apply_G_Function( void );
  void Apply_K2_Function( void );
